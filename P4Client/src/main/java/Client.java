...
public class Client extends Thread{
		...
		while(true) {
			...
			try {
				...
				if(gameInfoTemp.message != null) {	//client received message
					...
					/*if(gameInfoTemp.letter != '\u0000' && gameInfoTemp.positions.size()!=0) {
	...
	/*private void callbackGameInfo(GameInfo gameInfo) {
		System.out.println("In callbackGameInfo");
		String a =displayLetterPosition(gameInfo.positions);
		callback.accept("You have correctly guessed in position:" +a );
	}    */
